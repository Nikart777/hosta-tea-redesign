...
const slides = [
  {
    ...
    year: "1947",
    title: "Корни истории",
    description: "Всё началось в послевоенные годы. Именно на этих склонах, в туманных ущельях Сочи, были заложены первые семена, давшие жизнь самому северному чаю в мире.",
  ...
  },
  {
    id: 2,
    year: "43°",
    title: "Уникальный терруар",
    description: "Наш климат — наш главный союзник. Зимние морозы естественным образом защищают плантации, что позволяет нам выращивать чистый продукт без применения химии.",
  ...
  },
  {
    ...
    year: "3",
    title: "Верхних листа",
    description: "Мы сохраняем традиции ручного труда. Наши чаеводы бережно выбирают только лучшие флеши — почку и два верхних листочка, в которых сосредоточена вся польза.",
      ...
      */}
      <section ref={containerRef} className="relative h-[300vh] bg-hosta-dark hidden md:block">
        <div className="sticky top-0 h-screen overflow-hidden flex items-center w-full">
          ...
          {/* Листья убраны для снижения нагрузки на процессор */}
